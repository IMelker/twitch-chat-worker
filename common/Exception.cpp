...
Exception::Exception(int code) : _code(code) {
}

Exception::Exception(const std::string &msg, int code) : _msg(msg), _code(code) {
}

Exception::Exception(const std::string &msg, const std::string &arg, int code) : _msg(msg), _code(code) {
    if (!arg.empty()) {
        _msg.append(": ");
        _msg.append(arg);
    }
